...
images_icon = QIcon(str(icon_path/'images.svg'))
arrow_right_icon = QIcon(str(icon_path/'arrow_right.svg'))
arrow_left_icon = QIcon(str(icon_path/'arrow_left.svg'))
...
# Preprocessing status pictograms (ok / in-preprocessing / failed)
